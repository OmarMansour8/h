<%@ Page Title="" Language="C#" MasterPageFile="~/adminMaster.Master" AutoEventWireup="true" CodeBehind="adduser.aspx.cs" Inherits="WebApplication3.adduser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style4">
        ...
        <tr>
            <td style="text-align: center">&nbsp;</td>
            <td style="text-align: center">
                <asp:Button ID="btn1" runat="server" OnClick="btn1_Click" Text="Add" />
            </td>
            <td style="text-align: center">
